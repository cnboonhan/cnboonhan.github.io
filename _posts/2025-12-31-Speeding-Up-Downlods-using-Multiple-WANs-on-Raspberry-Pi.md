...
![Create USB Interface OpenWRT](images/blog-download-speedup/create-usb-interface-openwrt.png)
![Firewall Zone for USB Interface](images/blog-download-speedup/usb-interface-firewall-zone-openwrt.png)
![alt text](images/blog-download-speedup/set-gateway-metric-openwrt.png)
8. Configure the MultiWAN Manager under `cgi-bin/luci/admin/network/mwan3` with the following:
![alt text](images/blog-download-speedup/interfaces-openwrt.png)
![alt text](images/blog-download-speedup/multiwan-globals-openwrt.png)
![alt text](images/blog-download-speedup/multiwan-interfaces-openwrt.png)
![alt text](images/blog-download-speedup/multiwan-members-openwrt.png)
![alt text](images/blog-download-speedup/multiwan-policies-openwrt.png)
![alt text](images/blog-download-speedup/multiwan-rules-openwrt.png)
9. Run on SSH terminal: `mwan3 status`. Verify that both WANs are online, and the load balancing ratio is 50/50.
![alt text](images/blog-download-speedup/multiwan-status-openwrt.png)
10. Run on SSH terminal multiple times: `wget -qO- https://ipecho.net/plain ; echo`
![alt text](images/blog-download-speedup/load-balancing-result-openwrt.png)